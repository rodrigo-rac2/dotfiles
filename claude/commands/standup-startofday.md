# Standup Start of Day — Generate Morning Scrum Update

Generate a morning standup reply in the team's standard format, reading from the weekly work log and enriching with live Jira data.
...
Save the standup to:
- Path: `/Users/rac2/rac2/weekly-log/standups/YYYY/MM/DD-[company]-startofday.md`
...
---
Saved to standups/2026/04/03-propark-startofday.md
```
